...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__add_place_page__ = __webpack_require__(816);
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return GoogleMapsEvent; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return GoogleMaps; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return LatLngBounds; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return LatLng; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_add_observable_fromEvent__ = __webpack_require__(216);
...
var GoogleMap = (function () {
    function GoogleMap(element, options) {
        if (Object(__WEBPACK_IMPORTED_MODULE_1__ionic_native_core__["i" /* checkAvailability */])('plugin.google.maps.Map', null, 'GoogleMaps') === true) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_map_style__ = __webpack_require__(388);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__providers_parse_file_service__ = __webpack_require__(389);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_native_google_maps__ = __webpack_require__(814);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var AddPlacePage = (function (_super) {
    ...
    function AddPlacePage(injector, formBuilder, platform, place, googleMaps, camera, events, actionSheetCtrl) {
        ...
        _this.form = new __WEBPACK_IMPORTED_MODULE_7__angular_forms__["c" /* FormGroup */]({
            name: new __WEBPACK_IMPORTED_MODULE_7__angular_forms__["b" /* FormControl */]('', __WEBPACK_IMPORTED_MODULE_7__angular_forms__["h" /* Validators */].required),
            category: new __WEBPACK_IMPORTED_MODULE_7__angular_forms__["b" /* FormControl */]('', __WEBPACK_IMPORTED_MODULE_7__angular_forms__["h" /* Validators */].required),
            description: new __WEBPACK_IMPORTED_MODULE_7__angular_forms__["b" /* FormControl */](''),
            address: new __WEBPACK_IMPORTED_MODULE_7__angular_forms__["b" /* FormControl */](''),
            phone: new __WEBPACK_IMPORTED_MODULE_7__angular_forms__["b" /* FormControl */](''),
            website: new __WEBPACK_IMPORTED_MODULE_7__angular_forms__["b" /* FormControl */]('http://')
        });
    ...
    AddPlacePage.prototype.ionViewWillUnload = function () {
        ...
        if (this.map) {
            this.map.clear();
            this.map.setZoom(1);
            this.map.setCenter(new __WEBPACK_IMPORTED_MODULE_9__ionic_native_google_maps__["e" /* LatLng */](0, 0));
        }
    };
    AddPlacePage.prototype.ionViewDidLoad = function () {
        ...
        if (this.platform.is('cordova')) {
            ...
            var markerOptions = {
                position: new __WEBPACK_IMPORTED_MODULE_9__ionic_native_google_maps__["e" /* LatLng */](0, 0),
                icon: 'yellow'
            };
    ...
    AddPlacePage.prototype.onSearchAddress = function (event) {
        ...
        var geocoder = new __WEBPACK_IMPORTED_MODULE_9__ionic_native_google_maps__["a" /* Geocoder */];
        geocoder.geocode(request).then(function (results) {
            // create LatLng object
            var target = new __WEBPACK_IMPORTED_MODULE_9__ionic_native_google_maps__["e" /* LatLng */](results[0].position.lat, results[0].position.lng);
            // create CameraPosition
            var position = {
                target: target,
                zoom: 10
