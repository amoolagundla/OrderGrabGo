...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sign_in_page__ = __webpack_require__(709);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__providers_local_storage__ = __webpack_require__(152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__providers_ValuesService__ = __webpack_require__(151);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var SignInPage = (function (_super) {
    ...
    function SignInPage(injector, formBuilder, events, viewCtrl, valuesService, fb, googlePlus, storage) {
        ...
        _this.form = new __WEBPACK_IMPORTED_MODULE_3__angular_forms__["c" /* FormGroup */]({
